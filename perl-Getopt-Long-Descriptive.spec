...
Source0  : https://cpan.metacpan.org/authors/id/R/RJ/RJBS/Getopt-Long-Descriptive-0.111.tar.gz
...
%prep
%setup -q -n Getopt-Long-Descriptive-0.111
cd %{_builddir}/Getopt-Long-Descriptive-0.111
...
cp %{_builddir}/Getopt-Long-Descriptive-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/perl-Getopt-Long-Descriptive/f285360d72d04e8463035e2d805138258d9ac8df || :
if test -f Makefile.PL; then
