...
Source0  : https://cpan.metacpan.org/authors/id/R/RJ/RJBS/Getopt-Long-Descriptive-0.115.tar.gz
...
%prep
%setup -q -n Getopt-Long-Descriptive-0.115
cd %{_builddir}/Getopt-Long-Descriptive-0.115
pushd ..
cp -a Getopt-Long-Descriptive-0.115 buildavx2
popd
