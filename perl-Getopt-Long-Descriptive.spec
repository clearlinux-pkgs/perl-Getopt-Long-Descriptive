...
%prep
%setup -q -n Getopt-Long-Descriptive-0.105
cd %{_builddir}/Getopt-Long-Descriptive-0.105
...
cp %{_builddir}/Getopt-Long-Descriptive-0.105/LICENSE %{buildroot}/usr/share/package-licenses/perl-Getopt-Long-Descriptive/8b5e17836ab3a81ac7330abf4b518c85786ad172
if test -f Makefile.PL; then
